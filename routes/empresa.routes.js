...
const {
  createNewEmpresaController,
} = require("../controllers/empresa/createNewEmpresa.controller");
const {
...
// POST
empresaRouter.post("/", createNewEmpresaController);

// PUT
empresaRouter.put("/:id", putOneEmpresaController);

// DELETE
empresaRouter.delete(":id", deleteOneEmpresaController);
